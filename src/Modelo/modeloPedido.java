...
public class modeloPedido {
    ...
    */
    ...
    public modeloPedido(int id, int num_empleado, int id_arreglo, int estatus, int tiempo_estimado, Date hora_inicio, Date hora_final) {
        this.id = id;
    ...
    public String toString() {
        return "modeloPedido{" + "id=" + id + ", num_empleado=" + num_empleado + ", id_arreglo=" + id_arreglo + ", estatus=" + estatus + ", tiempo_estimado=" + tiempo_estimado + ", hora_inicio=" + hora_inicio + ", hora_final=" + hora_final + '}';
    }
